...
TILE_COLORS =  {
    0: (0, 0, 0),           # leer
    1: (255, 255, 0),       # kleiner Punkt
    2: (255, 0, 0),         # großer Punkt
    3: (0, 0, 255),         # vertikale Wand
    4: (0, 0, 255),         # horizontale Wand
    5: (0, 0, 255),         # Ecke oben rechts
    6: (0, 0, 255),         # Ecke oben links
    7: (0, 0, 255),         # Ecke unten links
...
def main():
    ...
    player_x = 32 #Startposition X
    player_y=32 #Startposition Y
    player_size = 25 #Breite und Höhe des Quadrats
    player_color = (0, 255, 0) #Grün
    ...
    screen = pygame.display.set_mode([WIDTH, HEIGHT])
    pygame.display.set_caption ("Virus Escape - Schritt 1")
